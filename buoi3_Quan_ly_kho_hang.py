# ==========================================
# HOẠT ĐỘNG 7: MINI PROJECT 2 - QUẢN LÝ KHO HÀNG
# ==========================================

# Khai báo kho hàng ban đầu (danh sách các tuple)
kho_hang = [
    ("Ban phim", 250000, 10),
    ("Chuot", 150000, 20),
    ("Man hinh", 2500000, 5),
...
# Tính tổng giá trị kho hàng bằng vòng lặp cộng dồn
tong_gia_tri = 0
for ten, gia, so_luong in kho_hang:
    tong_gia_tri = tong_gia_tri + gia * so_luong

print(f"\nTong gia tri kho hang: {tong_gia_tri:,} VNĐ")